...
const CompensationDetailsTab = ({ selectedLot, planId, landDetails }) => {
                ...
                <div className="space-y-6">
                  ...
                  <div className="border border-gray-200 rounded-lg p-4 bg-white/30">
                    <h4 className="font-semibold text-gray-800 mb-4 flex items-center gap-2">
                      ...
                      Full Payment
                      {isPaymentFilled('compensationPayment', 'fullPayment') && (
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            handlePaymentDetailsChange('compensationPayment', 'fullPayment', 'chequeNo', value);
                          }}
                  ...
                  <div className="border border-gray-200 rounded-lg p-4 bg-white/30">
                    <h4 className="font-semibold text-gray-800 mb-4 flex items-center gap-2">
                      ...
                      Part Payment 01
                      {isPaymentFilled('compensationPayment', 'partPayment01') && (
                        <Check className="w-5 h-5 text-green-600 ml-2" />
                      )}
                    </h4>
                    <div className="grid grid-cols-2 md:grid-cols-6 gap-4">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            const value = e.target.value.replace(/\D/g, ''); // Only allow digits
                            handlePaymentDetailsChange('compensationPayment', 'partPayment01', 'chequeNo', value);
                          }}
                  ...
                  <div className="border border-gray-200 rounded-lg p-4 bg-white/30">
                    <h4 className="font-semibold text-gray-800 mb-4 flex items-center gap-2">
                      ...
                      Part Payment 02
                      {isPaymentFilled('compensationPayment', 'partPayment02') && (
                        <Check className="w-5 h-5 text-green-600 ml-2" />
                      )}
                    </h4>
                    <div className="grid grid-cols-2 md:grid-cols-6 gap-4">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            const value = e.target.value.replace(/\D/g, ''); // Only allow digits
                            handlePaymentDetailsChange('compensationPayment', 'partPayment02', 'chequeNo', value);
                          }}
                ...
                <div className="space-y-6">
                  ...
                  <div className="border border-gray-200 rounded-lg p-4 bg-white/30">
                    <h4 className="font-semibold text-gray-800 mb-4 flex items-center gap-2">
                      ...
                      Full Payment
                      {isPaymentFilled('interestPayment', 'fullPayment') && (
                        <Check className="w-5 h-5 text-green-600 ml-2" />
                      )}
                    </h4>
                    <div className="grid grid-cols-2 md:grid-cols-6 gap-4">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            const value = e.target.value.replace(/\D/g, ''); // Only allow digits
                            handlePaymentDetailsChange('interestPayment', 'fullPayment', 'chequeNo', value);
                          }}
                        />
                      </div>
                      <div>
                  ...
                  <div className="border border-gray-200 rounded-lg p-4 bg-white/30">
                    <h4 className="font-semibold text-gray-800 mb-4 flex items-center gap-2">
                      ...
                      Part Payment 01
                      {isPaymentFilled('interestPayment', 'partPayment01') && (
                        <Check className="w-5 h-5 text-green-600 ml-2" />
                      )}
                    </h4>
                    <div className="grid grid-cols-2 md:grid-cols-6 gap-4">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            const value = e.target.value.replace(/\D/g, ''); // Only allow digits
                            handlePaymentDetailsChange('interestPayment', 'partPayment01', 'chequeNo', value);
                          }}
                        />
                      </div>
                      <div>
                  ...
                  <div className="border border-gray-200 rounded-lg p-4 bg-white/30">
                    <h4 className="font-semibold text-gray-800 mb-4 flex items-center gap-2">
                      ...
                      Part Payment 02
                      {isPaymentFilled('interestPayment', 'partPayment02') && (
                        <Check className="w-5 h-5 text-green-600 ml-2" />
                      )}
                    </h4>
                    <div className="grid grid-cols-2 md:grid-cols-6 gap-4">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            const value = e.target.value.replace(/\D/g, ''); // Only allow digits
                            handlePaymentDetailsChange('interestPayment', 'partPayment02', 'chequeNo', value);
                          }}
                        />
                      </div>
                      <div>
