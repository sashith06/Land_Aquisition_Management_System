  ...
  const reports = [
    {
      ...
      description: 'Comprehensive progress report for all active projects',
      date: '2025-01-15',
      type: 'PDF',
      size: '2.4 MB'
    },
    {
      ...
      description: 'Financial analysis and budget allocation report',
      date: '2025-01-10',
      type: 'Excel',
      size: '1.8 MB'
    },
    {
      ...
      description: 'Status report on land acquisition for all projects',
      date: '2025-01-05',
      type: 'PDF',
      size: '3.2 MB'
    },
    {
      ...
      description: 'Environmental impact analysis for new projects',
      date: '2024-12-28',
      type: 'PDF',
      size: '5.6 MB'
    }
